...
class RequestValidation(MyThread):
    ...
    def manager(self):
        ...
        # Always check weather the current request in the client GUI doesnt cross the server limits.
        while True:
            ...
            if not "Run File" in self.request_dict:
                ...
                # Iterate over all the titles in the request dict and check if their valid.
    ...
    def check_validation(self, limit, title):
        ...
        if title == "Run File":
            ...
            # The path the user supplied no longer exist.
            ...
            # For the rare case that the file has change right after the path validation.
            try:
