...
class RequestWindow(wx.Panel):
    ...
    def __init__(self, parent, gui):
        ...
        # The toolbar for the request window.
        self.toolbar = None
        self.start_request_tool = None
    ...
    def create_tool_bar(self):
        ...
        self.toolbar.SetBackgroundColour(Colours.main_window_toolbar)
        self.toolbar.SetSize((25, 25))

        # Add the buttons of the toolbar.
        self.start_request_tool = self.toolbar.AddTool(-1, wx.Bitmap("Resources/start_request.png"))

        # Bins the buttons with their functions.
        self.Bind(wx.EVT_TOOL, self.start_request, self.start_request_tool)

        self.toolbar.Realize()

        # Add the toolbar to the sizer.
        self.sizer.Add(self.toolbar, pos=(0, 0), flag=wx.BOTTOM, border=15)
    ...
    def create_files_part(self):
        ...
        self.additional_files = wx.ListBox(self, 78, style=wx.LB_SINGLE | wx.HSCROLL | wx.NB_MULTILINE)
    ...
    def create_commitments_and_privileges_part(self):
        ...
        self.number_of_executors_box = wx.ComboBox(self, choices=[str(i) for i in range(1, 10)], style=wx.CB_READONLY)
